...
const adocAbbreviationsPreprocess = require(`./abbreviation_preprocess.js`);
...
var default_T=function(){gulp.task('default', ['final_tasks'],function() {
...
var main_tasks_T=function(){gulp.task('main_tasks', ['init_copy_tasks'].concat(cfg.tasks),function() {
...
var final_tasks_T=function(){gulp.task('final_tasks', ['main_tasks'],function() {
	logger.debug('\n\n Begin final_tasks');			
...
var watch_T=function(){gulp.task('watch',['read_config'], function(){
	logger.debug(`
...
var init_copy_tasks_T=function(){
...
var copy_to_base_folder_T=function(){gulp.task('copy_to_base_folder',['read_config'],function() {
...
var copy_to_figures_folder_T=function(){gulp.task('copy_to_figures_folder',['read_config'],function() {
...
var copy_to_build_folder_T = function(){
	gulp.task('copy_to_build_folder',['copy_to_base_folder','copy_to_figures_folder'] ,function() {
...
var copy_custome_styles_to_build_folder_T = function(){
	gulp.task('copy_custome_styles_to_build_folder',['copy_to_build_folder'] ,function() {
...
var ADOC_T=function(){gulp.task('ADOC', ['adoc_4_adoc'],function() {
...
var adoc_4_adoc=function(){gulp.task('adoc_4_adoc', ['adoc_4_all'],function() {
...
var adoc_4_all_T=function(){gulp.task('adoc_4_all', ['init_copy_tasks'],function() {
	...
	var gulpresult=gulp		
		...
		.pipe(tap(function(file, t) {
			...
			file_contents_string=adocAbbreviationsPreprocess(file_contents_string);
...
//	- Citations
var adoc_4_docbook_T=function(){gulp.task('adoc_4_docbook', ['adoc_4_all'],function() {
...
var adoc_4_docbooktex_T=function(){gulp.task('adoc_4_docbooktex', ['adoc_4_all'],function() {
...
var adoc_4_html_T=function(){gulp.task('adoc_4_html', ['adoc_4_all'],function() {
...
//Convert original asciidoc to asciidoc but to be passed to html convertor
var adoc_4_docx_T=function(){gulp.task('adoc_4_docx', ['adoc_4_all'],function() {
...
var adoc_4_pdf_T=function(){gulp.task('adoc_4_pdf', ['init_copy_tasks'],function() {
...
var DOCX_T=function(){gulp.task('DOCX',['docx_f_adoc'],function(){ //
...
var docx_f_adoc_T=function(){gulp.task('docx_f_adoc', ['adoc_4_docx','html_f_adoc'],function(){
...
var HTML_T=function(){gulp.task('HTML',['html_f_adoc'],function(){ //
...
var html_f_adoc_T=function(){gulp.task('html_f_adoc', ['html_file','html_figures','html_css','html_js'],function(){
...
//Get 
var html_file_T=function(){gulp.task('html_file', ['init_copy_tasks','adoc_4_html'],function() {
...
//Get HTML-CSS
var html_css_T=function(){gulp.task('html_css', ['init_copy_tasks'],function() {
...
//Get HTML-JS
var html_js_T=function(){gulp.task('html_js', ['init_copy_tasks'],function() {
...
var html_figures_T=function(){gulp.task('html_figures', ['pngfigs','jpgfigs','svgfigs'],function() {
...
*/
var PRESENTATION_T=function(){gulp.task('PRESENTATION', ['pres_f_adoc'],function() {
...
var pres_f_adoc_T=function(){gulp.task('pres_f_adoc', ['pres_file','pres_figures','pres_css','pres_js'],function(){
...
var pres_file_T=function(){gulp.task('pres_file', ['init_copy_tasks','adoc_4_html'],function() {
...
//Get PRES-CSS
var pres_css_T=function(){gulp.task('pres_css', ['init_copy_tasks'],function() {
...
//Get PRES-JS
var pres_js_T=function(){gulp.task('pres_js', ['init_copy_tasks'],function() {
...
var pres_figures_T=function(){gulp.task('pres_figures', ['pngfigs','jpgfigs','svgfigs'],function() {
...
Direct PDF
*/
var PDF_DIRECT_T=function(){gulp.task('PDF_DIRECT', ['pdf_f_adoc'],function() {
...
var pdf_f_adoc_T=function(){gulp.task('pdf_f_adoc', ['init_copy_tasks','pngfigs'],function() {
...
var PDF_FOPUB_T=function(){gulp.task('PDF_FOPUB', ['pdffopub_f_adoc'],function() {
...
var pdffopub_f_adoc_T=function(){gulp.task('pdffopub_f_adoc', ['docbook_f_adoc','pngfigs'],function() {
...
//Get Docbook things
var DOCBOOK_T=function(){gulp.task('DOCBOOK', ['docbook_f_adoc'],function() {
...
var docbook_f_adoc_T=function(){gulp.task('docbook_f_adoc', ['adoc_4_docbook'],function() {
...
var docbook_f_adoc_4_tex_4_pdftex_T=function(){gulp.task('docbook_f_adoc_4_tex_4_pdftex', ['adoc_4_docbooktex'],function() {
	logger.debug(`
...
var dockbook_prep_4_tex_T=function(){gulp.task('dockbook_prep_4_tex', ['docbook_f_adoc_4_tex_4_pdftex'],function() {
...
var PDFFIGS_T=function(){gulp.task('pdffigs', ['pdffig_figures'],function() {
...
var pdffig_figures_T=function(){gulp.task('pdffig_figures', ['pdffigs_all'],function() {
...
var pdffigs_all_T=function(){gulp.task('pdffigs_all', ['pdffig_f_svg','pdffig_f_tikz'],function() {
...
var pdffig_f_svg_T=function(){gulp.task('pdffig_f_svg', ['init_copy_tasks'],function() {
...
var pdffig_f_tikz_T=function(){gulp.task('pdffig_f_tikz', ['init_copy_tasks'],function() {
...
// 'png_f_pdffig',
var pngfigs_T=function(){gulp.task('pngfigs', ['init_copy_tasks','png_f_svg','png_f_pdffig'],function() {
...
var jpgfigs_T=function(){gulp.task('jpgfigs', ['init_copy_tasks'],function() {
...
var png_f_pdffig_T=function(){gulp.task('png_f_pdffig', ['init_copy_tasks','pdffig_f_tikz','pdffig_f_svg'],function() {
...
var png_f_svg_T=function(){gulp.task('png_f_svg', ['init_copy_tasks'],function() {
...
var tex_f_adoc_T=function(){gulp.task('tex_f_adoc', ['init_copy_tasks'],function() {
...
var tex_f_docbook_T=function(){gulp.task('tex_f_docbook', ['tex_f_docbook_3_dblatex'],function() {
...
var tex_f_docbook_3_dblatex_T=function(){gulp.task('tex_f_docbook_3_dblatex', ['dockbook_prep_4_tex'],function() {
...
var tex_f_docbook_3_saxon_T=function(){gulp.task('tex_f_docbook_3_saxon', ['dockbook_prep_4_tex'],function() {
...
var tex_prep_templates_4_pdf_T=function(){gulp.task('tex_prep_templates_4_pdf', ['init_copy_tasks'],function() {
...
//Get Docbook things
var PDFTEX_T=function(){gulp.task('PDFTEX', ['pdftex_f_tex'],function() {
...
//Also tex_f_html
var pdftex_f_tex_T=function(){gulp.task('pdftex_f_tex', ['tex_f_docbook','tex_prep_templates_4_pdf','pdffig_figures'],function() {
...
var svgfigs_T=function(){gulp.task('svgfigs', ['init_copy_tasks','copy_to_figures_folder'],function() {
...
var tex_f_html_T=function(){gulp.task('tex_f_html', ['html_file'],function () {
